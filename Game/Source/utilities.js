...
// animation is totalFrames * 1000 / 60 * animspeed = period
// animspeed = period / (totalFrames * 1000 / 60)
// if you want to get it done 4x as fast, use multiple
// woops that's upside down. haaa.
function syncAnimation(animationSprite, period, multiple, play = true) {
  animationSprite.animationSpeed = (animationSprite.totalFrames * 1000 / 60) / period * multiple;
  if (play) {
